...
alias l='ls -CF'
alias lah='ls -lahF'
alias node='~/nodejs/node-v4.4.3-linux-x64/bin/node'
...
. /home/equi/.opam/opam-init/init.sh > /dev/null 2> /dev/null || true
...
# for gradle
export GRADLE_HOME="$HOME/gradle-3.2.1"
export PATH="$PATH:$GRADLE_HOME/bin"

# for emacs to start in terminal
